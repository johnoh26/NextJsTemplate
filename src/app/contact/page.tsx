...
export default function ContactPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    phone: "",
    message: "",
    requestType: isDemo ? "demo" : "general",
  });
      ...
      <section className="bg-gradient-to-br from-primary-50 to-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            {isDemo
              ? "See TaskFlow in action. Schedule a personalized demo with our team."
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">hello@taskflow.com</p>
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                ...
                <div className="flex space-x-4">
                  <a
                    href="#"
                    className="h-10 w-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-primary-100 transition-colors"
                  >
